...
csv_file = np.genfromtxt('/home/vittorix/Scrivania/Map_track1/center_x_track1.csv', 
                          delimiter=',', dtype=float)
center_x = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/vittorix/Scrivania/Map_track1/center_y_track1.csv', 
                          delimiter=',', dtype=float)
center_y = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/vittorix/Scrivania/Map_track1/bound_x1_track1.csv', 
                          delimiter=',', dtype=float)
bound_x1 = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/vittorix/Scrivania/Map_track1/bound_y1_track1.csv', 
                          delimiter=',', dtype=float)
bound_y1 = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/vittorix/Scrivania/Map_track1/bound_x2_track1.csv', 
                          delimiter=',', dtype=float)
bound_x2 = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/vittorix/Scrivania/Map_track1/bound_y2_track1.csv', 
                          delimiter=',', dtype=float)
...
R = 1.5
max_theta = 2* np.pi
list_t = list(np.arange(0,max_theta,0.01))
x_circle = [(R*math.cos(x_y) + obs_x) for x_y  in list_t]
y_circle = [(R*math.sin(x_y) + obs_y) for x_y  in list_t]
x_circle_2 = [(R*math.cos(x_y) + obs_x_2) for x_y  in list_t]
y_circle_2 = [(R*math.sin(x_y) + obs_y_2) for x_y  in list_t]
...
line8, = ax.plot(x_circle,y_circle,'r')
line9, = ax.plot(x_circle_2,y_circle_2,'r')
plt.ylim((-50,50))
plt.xlim((-50,50))
