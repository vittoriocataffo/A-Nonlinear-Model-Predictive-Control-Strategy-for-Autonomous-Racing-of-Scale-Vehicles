...
"""
import sys
sys.path.insert(1, "/home/gsilano/Pictures/nmpc_ws/PANOC_DYNAMIC_MOTOR_MODEL/dynamic_my_optimizer/dynamic_racing_target_point")
...
"""
csv_file = np.genfromtxt('/home/gsilano/Desktop/DATA/Map_track1/center_x_track3.csv',
                          delimiter=',', dtype=float)
center_x = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/gsilano/Desktop/DATA/Map_track1/center_y_track3.csv',
                          delimiter=',', dtype=float)
center_y = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/gsilano/Desktop/DATA/Map_track1/bound_x1_track3.csv',
                          delimiter=',', dtype=float)
bound_x1 = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/gsilano/Desktop/DATA/Map_track1/bound_y1_track3.csv',
                          delimiter=',', dtype=float)
bound_y1 = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/gsilano/Desktop/DATA/Map_track1/bound_x2_track3.csv',
                          delimiter=',', dtype=float)
bound_x2 = csv_file[:].tolist()
csv_file = np.genfromtxt('/home/gsilano/Desktop/DATA/Map_track1/bound_y2_track3.csv',
                          delimiter=',', dtype=float)
